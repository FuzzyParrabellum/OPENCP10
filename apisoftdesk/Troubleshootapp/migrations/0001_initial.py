    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignee_user_key', models.ForeignKey(default=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to=settings.AUTH_USER_MODEL), on_delete=django.db.models.deletion.SET_DEFAULT, related_name='assignee', to=settings.AUTH_USER_MODEL)),
